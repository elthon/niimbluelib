...
exports.NiimbotAbstractClient = exports.NIIMBOT_CLIENT_DEFAULTS = void 0;
...
exports.NIIMBOT_CLIENT_DEFAULTS = {
    packetIntervalMs: 10,
...
class NiimbotAbstractClient extends eventemitter3_1.EventEmitter {
    constructor() {
        ...
        this.heartbeatIntervalMs = exports.NIIMBOT_CLIENT_DEFAULTS.heartbeatIntervalMs;
        this.mutex = new async_mutex_1.Mutex();
        this.debug = false;
        this.packetBuf = new Uint8Array();
        /** @see https://github.com/MultiMote/niimblue/issues/5 */
        this.packetIntervalMs = exports.NIIMBOT_CLIENT_DEFAULTS.packetIntervalMs;
